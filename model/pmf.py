    ...
    def run(self):
        ...
        for current_time_step in range(start + 1, time_step_num + 1):
            ...
            for fold_id in range(self.fold_num):
                ...
                logging.info('begin to generate train and test file for' + self.model_name + ' ...\n')
                ...
                model_exe_path = '../../../graphchi-cpp/toolkits/collaborative_filtering/pmf'
                model_exe_fullpath = os.path.realpath(os.path.join(__file__,
                                                                   model_exe_path))
