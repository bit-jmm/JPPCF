...
logging.basicConfig(level=logging.DEBUG,
                    ...
                    filename='./log/tensor_k_' + str(k) + '.log',
                    filemode='w')
...
result_dir = time_filter_dir + '/tensor_fold_' + str(fold_num) + '_k_' + str(k)
...
for current_time_step in range(start+1, finT+1):
    ...
    for fold_id in range(fold_num):
        ...
        out = os.popen('../graphchi-cpp/toolkits/collaborative_filtering/als_tensor --training=' + time_train_path + '/timesvdpp_train' + ' --test=' + time_train_path + '/timesvdpp_test' + ' --lambda=0.065 --minval=0 --maxval=1 --max_iter=50 --K=27 --quiet=1')
        str1 = out.read()
        while str1 != '':
            print str1
            str1 = out.read()
        PredictR = util.create_predict_matrix(current_user_num, current_doc_num, current_data_path)
        NormPR = PredictR
        ...
        for recall_num in [3,5,10,20,50,100,150,200,250,300]:
            ...
            logging.info('\t\ttensor-als :  ' + str(timesvdpp_recall) + '\n')
            ...
            logging.info('\t\ttensor-als :  ' + str(timesvdpp_ndcg) + '\n')
            ...
            logging.info('\t\ttensor-als :  ' + str(timesvdpp_ap) + '\n')
    ...
    for recall_num in [3,5,10,20,50,100,150,200,250,300]:
        ...
        logging.info('\t\tavg tensor-als :  ' + str(avg_timesvdpp_recall) + '\n')
        ...
        logging.info('\t\tavg tensor-als :  ' + str(avg_timesvdpp_ndcg) + '\n')
        ...
        logging.info('\t\tavg tensor-als :  ' + str(avg_timesvdpp_ap) + '\n')
